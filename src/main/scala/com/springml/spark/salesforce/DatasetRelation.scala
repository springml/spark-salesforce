...
case class DatasetRelation  (
  ...
  private def read(): java.util.List[java.util.Map[String, String]] = {
    val waveAPI = APIFactory.getInstance.waveAPI(username, password, loginURL)
  ...
  override def schema: StructType = {
    if (userSchema != null) {
      ...
      // Construct the schema with all fields are String
