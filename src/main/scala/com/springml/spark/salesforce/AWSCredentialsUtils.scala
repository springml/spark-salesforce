 ...
 * Inspired by and partially copied from the Databricks Redshift implementation, which has Databricks copyright.
 ...
 /**
  ...
  def getCredentialsString(
    ...
    if (params.iamRole.isDefined) {
      ...
      throw new IllegalStateException("No spark-salesforce S3 authentication mechanism was specified")
    }
  }
